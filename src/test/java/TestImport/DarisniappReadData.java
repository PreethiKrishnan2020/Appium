...
public class DarisniappReadData extends SetUp {
	public String excelPath ="C://Users//user//Desktop//appium.xlsx";
	...
	public  String setValue(int i, int j, String cellValue) {
		try {
